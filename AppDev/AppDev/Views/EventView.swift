            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        HStack(spacing: 12) {
                            AsyncImage(
                                url: URL(string: "https://randomuser.me/api/portraits/men/32.jpg")
                            ) { image in
                                image
                                    .resizable()
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("About Event")
                                ...
                                .fontWeight(.semibold)
                            Text(
                                "Join us for the most anticipated tech event of 2025. "
                                + "Network with industry leaders, discover breakthrough innovations, "
                                + "and gain insights into the future of technology. "
                                + "This summit features keynote speakers from leading tech companies, "
                                + "hands-on workshops, and exclusive product launches."
                            )
                            .font(.subheadline)
                            .foregroundColor(.gray)
                        }
                            ...
                            HStack(spacing: -12) {
                                ForEach(0..<4) { index in
                                    AsyncImage(
                                        ...
                                        Circle().fill(Color(.systemGray4)).frame(
                                            width: 32, height: 32)
                                    }
                                }
                                ZStack {
